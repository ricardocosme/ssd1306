...
/** This is an educational demo to literally demonstrate what is going
    on when only one data byte is sent to the GDDRAM. */
int main() {
    ...
    */
    ...
    /** Finally the data byte can be sent to the RAM. Each data byte
        represents one column of a specific page. Each bit represents
        a dot(or a pixel) and the MSB is on the bottom of the column
        and the LSB on the top.
